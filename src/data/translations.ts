...
export const translations = {
  ar: {
    ...
    assessment: {
        ...
        noEvidenceAttached: "لم يتم إرفاق دليل",
        browse: "تصفح",
    ...
    zone_assessment: {
      subtitle: "نموذج قياس الأداء المؤسسي والمؤشرات التشغيلية",
      finalScore: "النتيجة النهائية",
      outOf100: "من أصل 100 نقطة",
      weight: "الوزن",
      addIndicator: "إضافة مؤشر",
      indicatorValue: "قيمة المؤشر",
      points: "النقاط",
      assessorNotes: "ملاحظات المقيم",
      assessorNotesPlaceholder: "أضف ملاحظات أو مبررات التقييم هنا...",
      editIndicator: "تعديل المؤشر",
      addIndicatorTitle: "إضافة مؤشر جديد",
      indicatorText: "نص المؤشر",
      measurementMechanism: "آلية القياس",
      maxWeight: "الوزن (الدرجة القصوى)",
      reset: "إعادة تعيين"
    },
    compliance: {
        saveButton: "حفظ سجل المخاطر والالتزام",
        statutoryTitle: "الالتزام النظامي والتشريعي",
        nonCompliant: "غير ممتثل",
  ...
  en: {
    ...
    zone_assessment: {
      subtitle: "Model for measuring institutional performance and operational indicators",
      ...
      assessorNotesPlaceholder: "Add assessment notes or justifications here...",
      editIndicator: "Edit Indicator",
      addIndicatorTitle: "Add New Indicator",
      indicatorText: "Indicator Text",
      measurementMechanism: "Measurement Mechanism",
      maxWeight: "Weight (Max Score)",
      reset: "Reset"
    },
    compliance: {
        saveButton: "Save Compliance & Risks",
        statutoryTitle: "Statutory & Legislative Compliance",
        nonCompliant: "Non-Compliant",
