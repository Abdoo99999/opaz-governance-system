...
const ApprovalRequests: React.FC<ApprovalRequestsProps> = ({ onNavigate }) => {
                                ...
                                <TableBody>
                                    {submittedCompanies.map(company => (
                                        <TableRow key={company.id} className="border-b-white/10 hover:bg-white/5">
                                            ...
                                            <TableCell>{company.submissionDate ? format(parseISO(company.submissionDate), 'd MMMM yyyy') : '-'}</TableCell>
                                                ...
                                                <div className="flex justify-center gap-2">
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <Button variant="ghost" size="icon" className="text-gray-400 hover:text-white" onClick={() => handleViewReport(company.id)}>
                                                    ...
                                                    <AlertDialog>
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent className="glass text-white"><p>{t('approvals.approve')}</p></TooltipContent>
                                                        </Tooltip>
